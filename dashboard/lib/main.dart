...
class _LineChartSample2State extends State<LineChartSample2> {
              ...
              child: Container(
                decoration: const BoxDecoration(
                    borderRadius: BorderRadius.all(
                      Radius.circular(0), //borda curva
                    ),
                    color: Color(0xff232d37)), //cor fundo
                child: Padding(
                  padding: const EdgeInsets.only(right: 18.0, left: 12.0, top: 24, bottom: 12), //margens grafico
                  child: LineChart(
                    showAvg ? avgData() : mainData(), //se botão avg for true pega os dados
                  ),
                ),
              ),
            ),
  ...
  LineChartData mainData() {
    return LineChartData(
      gridData: FlGridData(
        show: true,
        drawVerticalLine: false, // desabilitar linhas verticais
        getDrawingHorizontalLine: (value) {
          return FlLine(
            color: const Color(0xff37434d), // cor linha da grade
            strokeWidth: 1,
          );
        },
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          isCurved: true, //se é curvado ou nao
          colors: gradientColors, //pega o mix de cores informado no inicio
